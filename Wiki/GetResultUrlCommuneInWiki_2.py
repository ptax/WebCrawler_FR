    ...
    for Result in ColResult:
        ...
        if ThemeCodeCommuneInSnipent in Result:
            ...
            if NameCommune in Titel:
                DictCommune.update(
                    {'Wiki_UrlInCommune': Url, 'Wiki_NameSnipet': Titel, 'ColResultInSnipet': ColResultLen})
            else:
                DictCommune.update(
                    {'Wiki_Old_UrlInCommune': Url, 'Wiki_Old_NameSnipet': Titel, 'ColResultInSnipet': ColResultLen})
    return DictCommune
